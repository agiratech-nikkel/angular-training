...
export class EditComponent implements OnInit {
  ...
  division = [
    ...
    { key: 'FrontEnd UI', value: 'FrontEnd UI' },
  ...
  ngOnInit(): void {
    localStorage.getItem('EmpolyeeData')
    ...
    this.editForm = this.fb.group({
      ...
      phoneNumber: new FormControl(this.data[0].phonenumber, [
        Validators.required,
        Validators.pattern('^[0-9]{10}$'),
      ]),
      email: new FormControl(this.data[0].email, [
        Validators.required,
        Validators.email,
      ]),
      deprtment: new FormControl(this.data[0].Department, [
        Validators.required,
      ]),
      division: new FormControl(this.data[0].division, [Validators.required]),
      dob: new FormControl(this.data[0].dob, [Validators.required]),
      expericnce: new FormControl(this.data[0].Expericnce, [
        Validators.required,
      ]),
      ...
      lastProject: new FormControl(this.data[0].lastproject, [
        Validators.required,
      ]),
    });
  }
  ...
  editSubmit() {
    ...
    this.dat = this.empUpdate.findIndex((d: any) => {
      return d.id == this.data[0].id;
    });
    this.editObj = {
